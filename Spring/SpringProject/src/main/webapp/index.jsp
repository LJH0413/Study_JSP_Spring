...
<html lang="ko">
  <head>
    ...
    <script src="https://kit.fontawesome.com/46d3d8cf24.js" crossorigin="anonymous"></script>
      ...
      <div class="section__container">
        ...
        <div class="course__wrapper">
          <div class="course__img">
            <img class="c__img" src="resources/images/course/gangnam.jpg" alt="desert" />
            <h2 class="c__description">강남</h2>
          </div>
  
          <div class="course__img">
            <img class="c__img" src="resources/images/course/gunggu.jpg" alt="desert" />
              <h2 class="c__description">종로</h2>
          </div>
  
          <div class="course__img">
            <img class="c__img" src="resources/images/course/hongdae.jpg" alt="desert" />
              <h2 class="c__description">홍대</h2>
          </div>
  
          <div class="course__img">
            <img class="c__img" src="resources/images/course/hannam.png" alt="desert" />
              <h2 class="c__description">한남동</h2>
          </div>
  
          <div class="course__img">
            <img class="c__img" src="resources/images/course/itaewon.jpg" alt="desert" />
              <h2 class="c__description">이태원</h2>
          </div>
  
          <div class="course__img">
            <img class="c__img" src="resources/images/course/sungsu.JPG" alt="desert" />
    ...
    <section id="recommend" class="section">
      <div class="section__container">
        ...
        <div class="mySlides fade">
            <img class="imgs" src="resources/images/recommend/1.png" style="width: 80%"/>
            <img class="imgs" src="resources/images/recommend/2.png" style="width: 80%"/>
        </div>
  
        <div class="mySlides fade">
          <img class="imgs" src="resources/images/recommend/4.png" style="width: 80%"/>
          <img class="imgs" src="resources/images/recommend/3.png" style="width: 80%"/>
        </div>
  
        <div class="mySlides fade">
          <img class="imgs" src="resources/images/recommend/6.png" style="width: 80%"/>
          <img class="imgs" src="resources/images/recommend/7.png" style="width: 80%"/>
        </div>
  
        <div class="mySlides fade">
          <img class="imgs" src="resources/images/recommend/8.png" style="width: 80%"/>
          <img class="imgs" src="resources/images/recommend/9.png" style="width: 80%"/>
        </div>
